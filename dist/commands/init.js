...
function buildDefaultConfig(projectName, withPostgres) {
...
function buildNodePreset(projectName) {
    const nameComment = projectName ? `  // Project: ${projectName}\n` : "";
...
function buildNextPreset(projectName) {
    const nameComment = projectName ? `  // Project: ${projectName}\n` : "";
    return `import { defineConfig, defaultPlugins, direnv } from "wtenv";
...
function buildRailsPreset(projectName) {
...
function buildConfig(projectName, withPostgres, preset) {
    switch (preset) {
        case "node":
